...
<div class="card-grey-chart mb-2">
    <div class="row">
        <div class="col-12">
                ...
                @if ($success_array['current_week_days_text_green'] != '')
                    <div class="row gx-2">
                        ...
                        <div class="col-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19"
                                ...
                                <rect id="Rectangle_14941"
                                      data-name="Rectangle 14941" width="19"
                                      height="19" rx="3" fill="#00d277" />
                            </svg>
                        </div>
                    </div>
                @endif
                @if ($success_array['last_year_current_week_days_text_red'] != '')
                    <div class="row gx-2">
                        <div class="col-11 text-end">
                        ...
                        <div class="col-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19"
                                 height="19" viewBox="0 0 19 19">
                                <rect id="Rectangle_14943"
                                      data-name="Rectangle 14943" width="19"
                                      height="19" rx="3" fill="#fe0000" />
                            </svg>
                        </div>

                    </div>
                @endif
                @if ($success_array['last_four_week_days_text_blue'] != '')
                    <div class="row gx-2">
                        <div class="col-11 text-end">
                        ...
                        <div class="col-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19"
                                 height="19" viewBox="0 0 19 19">
                                <rect id="Rectangle_14942"
                                      data-name="Rectangle 14942" width="19"
                                      height="19" rx="3" fill="#2471a3" />
                            </svg>
                        </div>
                    </div>
                @endif
    ...
    <div class="BoxPlogGroupchartWrap js-plotly-plot" style="min-height: 290px;">
        ...
        <div id="GroupedBoxplotChartLive"></div>
    </div>
</div>

<div class="attendence-details" id="attendence-details">
...
<script>
    ...
    var GroupedBoxplotChartLive = data[0];
    var layout = {
        xaxis: {
            visible: true,
            color: '#000',
    ...
    Plotly.newPlot("GroupedBoxplotChartLive", GroupedBoxplotChartLive, layout, config);
    function EdOverviewLoadAfterScriptGraphLive() {
        Plotly.newPlot("GroupedBoxplotChartLive", GroupedBoxplotChartLive, layout, config);
    }
</script>
