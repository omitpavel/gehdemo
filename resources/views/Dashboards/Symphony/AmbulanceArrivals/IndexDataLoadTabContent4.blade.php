    ...
    <div class="container-fluid">
        <div class="col-lg-12  ">
            <div class="card-ambulance-chart">
                <div class="card-grey">
                    <div class="row">
                        <div id="ambulance_arrivals_count_tab_4"></div>
                    </div>
                </div>
            </div>
            <div class="row gx-2">
                        ...
                        <div class="card-body">
                            <div class="row set_height">
                                <div class="col-lg-6 ">
                                    ...
                                    <div id="admitted_non_admitted_box_plot_1_tab_4"></div>
                                    <div id="ambulance_admitted_barchart_tab_4" class="pt-3"></div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div id="admitted_non_admitted_box_plot_2_tab_4"> </div>
                                    <div id="ambulance_non_admitted_barchart_tab_4" class="pt-3"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-grey">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div id="admitted_non_admitted_box_plot_3_tab_4"></div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div id="admitted_non_admitted_box_plot_4_tab_4"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    if (document.querySelector("#ambulance_arrivals_count_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#ambulance_arrivals_count_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_1_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_1_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_2_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_2_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_3_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_3_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_4_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_4_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#ambulance_admitted_barchart_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#ambulance_admitted_barchart_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
    ...
    if (document.querySelector("#ambulance_non_admitted_barchart_tab_4")) {
        var chart = new ApexCharts(document.querySelector("#ambulance_non_admitted_barchart_tab_4"), apex_chart_settings_options_temp);
        chart.render();
    }
