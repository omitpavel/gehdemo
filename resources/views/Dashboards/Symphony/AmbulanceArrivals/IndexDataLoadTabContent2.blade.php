    ...
    <div class="container-fluid">
        <div class="col-lg-12  ">
                        ...
                        <div class="">
                            <div class="d-flex align-items-center tile-shape">
                                <div class="month-select">
                                    <select class="form-select w-100" aria-label="Default select example" name="start_date_week_summary" id="start_date_week_summary">
                                        <option selected="">Months</option>
                                        @if (count($success_array['week_filter_array']))
                                            @foreach ($success_array['week_filter_array'] as $key => $row)
                ...
                <div class="col-lg-9 weekly-ambulance-count">
                    <div class="row row-cols-7 gx-2" id="week-details">
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'monday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'monday')
                        ...
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'tuesday')) d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'tuesday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
                        ...
                        <div class="col mb-2 mb-xxl-0 {{ $success_array['filter_value_selected'] }}">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'wednesday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'wednesday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
                        ...
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'thursday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'thursday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
                        ...
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'friday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'friday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
                        ...
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'saturday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'saturday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
                        ...
                        <div class="col mb-2 mb-xxl-0">
                            <div class=" @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'sunday') d-flex justify-content-between @endif blue-top">
                                @if (strtotime($success_array['filter_value_selected'])  >= strtotime('-7 days') && strtolower(date('l')) == 'sunday')
                                    <h6 class="bg-live-yellow">Live</h6>
                                @endif
            ...
            <div class="card-ambulance-chart">
                <div class="card-grey">
                    <div class="row">
                        <div id="ambulance_arrivals_count_tab_2"></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row set_height">
                                <div class="col-lg-6 ">
                                    ...
                                    <div id="admitted_non_admitted_box_plot_1_tab_2"></div>
                                    <div id="ambulance_admitted_barchart_tab_2" class="pt-3"></div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div id="admitted_non_admitted_box_plot_2_tab_2">
                                    </div>
                                    <div id="ambulance_non_admitted_barchart_tab_2" class="pt-3"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-grey">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div id="admitted_non_admitted_box_plot_3_tab_2"></div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div id="admitted_non_admitted_box_plot_4_tab_2"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var obj_ambulance_arrivals_count_tab_2 = '';
    var obj_admitted_non_admitted_box_plot_1_tab_2 = '';
    var obj_admitted_non_admitted_box_plot_2_tab_2 = '';
    var obj_admitted_non_admitted_box_plot_3_tab_2 = '';
    var obj_admitted_non_admitted_box_plot_4_tab_2 = '';
    var obj_ambulance_admitted_barchart_tab_2 = '';
    var obj_ambulance_non_admitted_barchart_tab_2 = '';

    function AmbulanceArrivalApexChartDestroyTab2() {
        if (typeof obj_ambulance_arrivals_count_tab_2 === 'object') {
            obj_ambulance_arrivals_count_tab_2.destroy();
        }
        if (typeof obj_admitted_non_admitted_box_plot_1_tab_2 === 'object') {
            obj_admitted_non_admitted_box_plot_1_tab_2.destroy();
        }
        if (typeof obj_admitted_non_admitted_box_plot_2_tab_2 === 'object') {
            obj_admitted_non_admitted_box_plot_2_tab_2.destroy();
        }
        if (typeof obj_admitted_non_admitted_box_plot_3_tab_2 === 'object') {
            obj_admitted_non_admitted_box_plot_3_tab_2.destroy();
        }
        if (typeof obj_admitted_non_admitted_box_plot_4_tab_2 === 'object') {
            obj_admitted_non_admitted_box_plot_4_tab_2.destroy();
        }
        if (typeof obj_ambulance_admitted_barchart_tab_2 === 'object') {
            obj_ambulance_admitted_barchart_tab_2.destroy();
        }
        if (typeof obj_ambulance_non_admitted_barchart_tab_2 === 'object') {
            obj_ambulance_non_admitted_barchart_tab_2.destroy();
        }
    }
    ...
    if (document.querySelector("#ambulance_arrivals_count_tab_2")) {
        obj_ambulance_arrivals_count_tab_2 = new ApexCharts(document.querySelector("#ambulance_arrivals_count_tab_2"), apex_chart_settings_options_temp);
        obj_ambulance_arrivals_count_tab_2.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_1_tab_2")) {
        obj_admitted_non_admitted_box_plot_1_tab_2 = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_1_tab_2"), apex_chart_settings_options_temp);
        obj_admitted_non_admitted_box_plot_1_tab_2.render();
    }
    ...
    apex_chart_settings_options_temp['series'] = [{
        data: [{
            x: '',
           y: [{{ $success_array['admitted_non_admitted_section']['non_admitted']['box_plot_minimum'] }}, {{ $success_array['admitted_non_admitted_section']['non_admitted']['box_plot_lower_quartile'] }}, {{ $success_array['admitted_non_admitted_section']['non_admitted']['box_plot_median'] }}, {{ $success_array['admitted_non_admitted_section']['non_admitted']['box_plot_upper_quartile'] }}, {{ $success_array['admitted_non_admitted_section']['non_admitted']['box_plot_maximum'] }} ]
        }]
    }];
    if (document.querySelector("#admitted_non_admitted_box_plot_2_tab_2")) {
        obj_admitted_non_admitted_box_plot_2_tab_2 = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_2_tab_2"), apex_chart_settings_options_temp);
        obj_admitted_non_admitted_box_plot_2_tab_2.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_3_tab_2")) {
        obj_admitted_non_admitted_box_plot_3_tab_2 = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_3_tab_2"), apex_chart_settings_options_temp);
        obj_admitted_non_admitted_box_plot_3_tab_2.render();
    }
    ...
    if (document.querySelector("#admitted_non_admitted_box_plot_4_tab_2")) {
        obj_admitted_non_admitted_box_plot_4_tab_2 = new ApexCharts(document.querySelector("#admitted_non_admitted_box_plot_4_tab_2"), apex_chart_settings_options_temp);
        obj_admitted_non_admitted_box_plot_4_tab_2.render();
    }
    ...
    if (document.querySelector("#ambulance_admitted_barchart_tab_2")) {
        obj_ambulance_admitted_barchart_tab_2 = new ApexCharts(document.querySelector("#ambulance_admitted_barchart_tab_2"), apex_chart_settings_options_temp);
        obj_ambulance_admitted_barchart_tab_2.render();
    }
    ...
    if (document.querySelector("#ambulance_non_admitted_barchart_tab_2")) {
        obj_ambulance_non_admitted_barchart_tab_2 = new ApexCharts(document.querySelector("#ambulance_non_admitted_barchart_tab_2"), apex_chart_settings_options_temp);
        obj_ambulance_non_admitted_barchart_tab_2.render();
    }
