                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="date-box w-90">
                                                    <input type="hidden" value="{{ $success_array['filter_value_selected'] }}" class="breach_tab_2_date_selected" id="breach_tab_2_date_selected">
                                                    <input readonly='readonly' type="text" placeholder="{{ $success_array['date_filter_tab_2_date_to_show'] }}" class="datepickerInput" value="" id="date_picker_tab_2" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="rectangle-block-1 ">
                                                    ...
                                                    <div class="rectangle-block-2">
                                                        <div class="row gx-2 fs-12 align-items-center">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-3">
                                                                <p class="mb-0 lh-sm">
                                                                    Average Past <br> 7 Days</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-3">
                                                                <p class="mb-0 lh-sm">
                                                                    Average Past <br> 4 Weeks
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-12 bottom-section">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-3 col-md-3 col-3">
                                                        <p class="mb-0">Total Attendence</p>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-3">
                                ...
                                <div class="col-lg-4 col-md-4 ps-md-1  text-center">
                                    <div class="rectangle-breach p-0">
                                        <div class="gauge-head pt-2">
                                            ...
                                            <input type="hidden" id="performance_percent" value="{{ $success_array['performance']['performance'] }}">
                                            <h4 class="fw-bold mb-0 ">{{ $success_array['performance']['performance'] }}%
                                            </h4>
                                        </div>
                            ...
                            <div class="rectangle-block-1 mb-2">
                                ...
                                <div class="row gx-2 align-items-center">
                                    <div class="col-lg-6 col-md-6">
                                        <div @if (CheckSpecificPermission('breach_dashboard_ambulance_data_view')) class="row gx-2 align-items-center ambulance-details-leftside  ambulance_data_adjust_on_date " @else class="row gx-2 align-items-center" onclick="CommonLoginModalPopupOpenOnRequest();" @endif>
                                            <div class="col-md-2 col-2 text-center  hand-on-breach-ambulance-change">
                                            ...
                                            <div class="col-md-3 col-5 offset-2 offset-md-0 text-md-center " style="cursor: pointer;">
                                            ...
                                            <div class="col-md-3 col-4 offset-1 offset-md-0 text-md-center" style="cursor: pointer;">
                                                <p class="mb-0 fs-12 lh-sm">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="row gx-2 align-items-center mb-2 mb-md-0 ambulance-details-rightside">
                                            ...
                                            <div class="col-md-4 col-4 text-md-center">
                                                ...
                                                <h6 class="mb-0 fw-bold">
                                                    {{ $success_array['ambulance_arrival']['admitted_count'] }} ({{ $success_array['ambulance_arrival']['admitted_perc'] }} %)
                                                </h6>
                            ...
                            <div class="rectangle-block-1 mb-2">
                                ...
                                <div class="row gx-2 align-items-center breach-count-section">
                                    ...
                                    <div class="col-4 text-center">
                                        <div class="position-relative">
                                            <h6>Ambulance</h6>
                                            <h5 class="fw-bold ">{{ $success_array['breach_data']['ambulance']['breach_count'] }} ({{ $success_array['breach_data']['ambulance']['breach_perc'] }}%)</h5>
                                    ...
                                    <div class="col-4 text-center">
                                        <h6>Walk In</h6>
                                        <h5 class="fw-bold ">{{ $success_array['breach_data']['walk_in']['breach_count'] }} ({{ $success_array['breach_data']['walk_in']['breach_perc'] }}%)</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="rectangle-block-1 mb-2">
                                                        ...
                                                        @if (count($success_array['breach_reason']) > 0)
                                                            @foreach ($success_array['breach_reason'] as $row)
                                                                <tr class="@if ($loop->even) bg-white @else bg-grey @endif">
                                                                    ...
                                                                    <td class="text-center">{{ $row['admitted_count'] }}</td>
                                                                    <td class="text-center">{{ $row['discharged_count'] }}</td>
                                                                </tr>
                                                            @endforeach
                                                        @else

                                                            <tr class="row-no-data">
                                                                <td colspan="4" class="cell-no-data"> <span>{{ NotFoundMessage() }}</span>
                                                                </td>
                                                            </tr>
                                                        @endif
                            ...
                            @foreach ($success_array['performance_by_speciality'] as $key => $row)
                                <div class="@if ($loop->first) col pe-lg-0 border-breach-end @elseif($loop->last) col ps-lg-0 border-breach-end @else col ps-lg-0 pe-lg-0 border-breach-end @endif ">
                                    <div class="">
                                        ...
                                        <div class="breach-chart{{ $loop->iteration }}">
                                            <div id="gehBreachChart{{ $loop->iteration }}"></div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between align-items-center rectangle-block-2">
                                            ...
                                            <h6 class="fw-header-500 fs-5 mb-0">
                                                {{ collect($success_array['all_attendence'])->sum('attendence_count') }}
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="past-seven-days-section">
                                                <table class="table-breach">
                                                    ...
                                                    <tbody>
                                                        @if (count($success_array['past_seven_days']) > 0)
                                                            @foreach ($success_array['past_seven_days'] as $row)
                                                                <tr class="@if ($loop->even) bg-white @else bg-grey @endif">
                                                                    <td>{{ $row['date_val'] }}</td>
                                                ...
                                                <table class="table-breach-sp">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class=""></th>
                                                            <th class="text-center">{{ $success_array['ed_attendance_summary_show'][0]['week'] }}</th>
                                                            <th class="text-center">{{ $success_array['ed_attendance_summary_show'][0]['month'] }}</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="bg-white">
                                                            ...
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][1]['week'] }}%</td>
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][1]['month'] }}%</td>
                                                        ...
                                                        <tr class="bg-grey">
                                                            ...
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][2]['week'] }}</td>
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][2]['month'] }}</td>
                                                        ...
                                                        <tr class="bg-white">
                                                            ...
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][3]['week'] }}</td>
                                                            <td class="text-center">{{ $success_array['ed_attendance_summary_show'][3]['month'] }}</td>
...
<button class="d-none breach_day_summary_search"></div>
...
<script>
    ...
    function cb(start) {
        $('#breach_tab_2_date_selected').val(start.format('MMMM D, YYYY'));
        $('#date_picker_tab_2').val(start.format('ddd MMMM D, YYYY'));
        if(start.format('YYYY-MM-DD') != '{{$success_array['filter_value_selected']}}'){
            $(".breach_day_summary_search").click();
        }
    }


        $('#date_picker_tab_2').daterangepicker({
...
@foreach ($success_array['performance_by_speciality'] as $key => $row)
    <script>
        ...
        if (document.querySelector("#gehBreachChart{{ $loop->iteration }}")) {
            if (chart{{ $loop->iteration }}) {
                chart{{ $loop->iteration }}.destroy();
            }
            var chart{{ $loop->iteration }} = new ApexCharts(document.querySelector("#gehBreachChart{{ $loop->iteration }}"), options);
            chart{{ $loop->iteration }}.render();
        }
    </script>
@endforeach
