                ...
                <div class="row gx-2 referral-filters">
                    ...
                    <div class="col-lg-3 col-md-5 mb-2">
                        <div class="d-flex justify-content-between">
                            <input class="form-control" type="text" id="referral_search_text" placeholder="" aria-label="default input example" value="{{ request()->search_text }}">
                    ...
                    <div class="col-lg-2 col-md-3 mb-2">
                        <button type="button" class="btn btn-export w-100" onclick="DataPageLoad('{{ request()->tab }}', '', '');">
                            <img src="{{ asset('asset_v2/Template/icons/reset.svg') }}" alt="" width="16" class="me-1">Reset Search
                        </button>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="custom-card">
                                            <table class="responsiveTable table-custom">
                                                ...
                                                @foreach ($patients_list as $patient)
                                                    <tbody class="table-patient-tbody tbody_id_{{ $patient['camis_patient_id'] }}">
                                                        <tr class="table-patient-row-1">
                                                            ...
                                                            <td class="pivoted">
                                                                ...
                                                                <span
                                                                    class="{{ @$patient['board_round_medically_fit_data']['patient_medically_fit_status'] == 1 ? 'medifit-text-success' : 'medifit-text-danger' }}">
                                                                    @if (isset($patient['board_round_medically_fit_data']['patient_medically_fit_status']) &&
                                                                            $patient['board_round_medically_fit_data']['patient_medically_fit_status'] == 1)
                                                                        Yes
                                                                        {{ isset($patient['board_round_medically_fit_data']['updated_at']) ? '- ' . PredefinedDateFormatWithoutYear($patient['board_round_medically_fit_data']['updated_at']) . '' : '' }}
                                                                    @else
                                                                        No
                                                                    @endif
                                                                </span>
                                                        ...
                                                        <tr class="table-patient-row-2">
                                                            <td class="pivoted">
                                                                ...
                                                                <div class="wrapper-buttons {{ PermissionDeniedDiv('discharge_tracker_referral_update') }}">
                                                                    <button
                                                                        class="btn btn-approve {{ DisabledButtonOnRolePermission('discharge_tracker_referral_update') }} cdt_approval_button" data-status="1"
                                                                        data-patient_id="{{ $patient['camis_patient_id'] }}">Accept
                                                                    </button>
                                                                    <button onclick="ActionButton('{{ $patient['camis_patient_id'] }}', 3);"
                                                                        class="btn btn-review {{ DisabledButtonOnRolePermission('discharge_tracker_referral_update') }}">To
                                                                        Review</button>
                                                                    <button  onclick="ActionButton('{{ $patient['camis_patient_id'] }}', 2);"
