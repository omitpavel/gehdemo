                                                ...
                                                @foreach ($patients_list as $patient)
                                                    <tbody
                                                        ...
                                                        <tr class="table-patient-row-1">
                                                            ...
                                                            <td class="pivoted">
                                                                <div class="tdBefore">Referral Rejected
                                                                </div>
                                                                <span>{{ PredefinedDateFormatFor24Hour($patient['board_round_cdt']['rejected_date']) }}
                                                                    ({{ $patient['board_round_cdt']['rejected_by_username'] ?? '' }})
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        @php
                                                        ...
                                                        <tr class="table-patient-row-2">
                                                            <td class="pivoted">
                                                                <div class="note-grp">
                                                                    <div class="tdBefore">Reject Reason
                                                                    </div>
                                                                    <div
                                                                        class="wrapper-buttons  {{ PermissionDeniedDiv('discharge_tracker_referral_update') }}">
                                                                        <button
                                                                            onclick="ActionButton('{{ $patient['camis_patient_id'] }}', 3);"
                                                                            class="btn btn-review">To
                                                                            Review</button>

                                                                    </div>
                                                                </div>
                                                                <textarea class="form-control reject_reason_{{ $patient['camis_patient_id'] }}"
                                                                    data-id="{{ $patient['board_round_c_d_t_comment_history']['0']['id'] ?? '' }}" readonly>{{ $patient['board_round_c_d_t_comment_history']['0']['cdt_comment'] ?? '' }}</textarea>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                @endforeach
