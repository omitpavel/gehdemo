                ...
                <tbody>
                    @foreach ($patient_list as $patient)
                        <tr>
                            ...
                            <td class="pivoted">
                                <div class="tdBefore">Therapy Fit</div>
                                {{ @$patient['board_round_therapy_fit_data']['patient_therapy_fit_status'] == 1 ? 'YES' : 'No' }} @if(isset($patient['board_round_therapy_fit_data']['updated_at']) && $patient['board_round_therapy_fit_data']['patient_therapy_fit_status'] == 1)- {{ PredefinedDateFormatWithoutYear($patient['board_round_therapy_fit_data']['updated_at']) }} @endif
                            </td>
                            <td class="pivoted">
                            ...
                            <td class="pivoted">
                                <div class="tdBefore">CDT Status</div>
                                {{ @$patient['board_round_cdt']['cdt_status'] == 1 ? 'YES' : 'No' }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
