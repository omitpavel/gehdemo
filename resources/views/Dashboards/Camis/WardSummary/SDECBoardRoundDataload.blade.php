...
<div class="col-lg-12">
    <div class="row gx-2 align-items-center">
        ...
        <div class="col-lg-2 col-md-6 order-2 order-lg-2 mb-1">
            <div class="btn-col ">
                <a class="btn btn-allebone w-100" id="board_round_close" href="{{ route('ward.sdec') }}"><img src="{{ asset('asset_v2/Template') }}/icons/cancel.svg"
    ...
    <div class="footer-buttons">
        <div class="row gx-2 ">
            ...
            <div class="col-lg-3 col-6">
                <button class="btn btn-allebone w-100" id="board_round_cancel" onclick="location.href='{{ route('ward.sdec') }}';" ><img src="{{ asset('asset_v2/Template') }}/icons/cancel.svg" alt=""
