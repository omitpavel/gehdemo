<input type="hidden" value="{{ $sdec_ward_id }}" id="ward_id">
<div class="col-lg-12">
    <div class="ward-summary-header">
        <div class="row">
            <div class="col-xxl-2 col-lg-4 col-md-3 mb-2">
                <div class="tasks">
                    <div class="row g-2">
                        <div class="col-4">
                                        ...
                                        <g id="Group_2695" data-name="Group 2695">
                                            <g id="Group_2692" data-name="Group 2692">
                                                ...
                                                <text id="!" transform="translate(13.001 22.607)" fill="#FC0000"
                                                    font-size="22" font-family="Oxygen-Bold, Oxygen"
                                                    font-weight="700">
                                                    <tspan x="0" y="0">!</tspan>
                                                </text>
                                            </g>
            ...
            <div class="col-xxl-2 col-lg-5 col-md-6 mb-2">
                <div class="row">
            ...
            <div class="col-xxl-2 col-lg-3 col-md-3 mb-2">
                <div class="edd-header">
                    <div class="grey-tile-bottom">
                        <div class="edd-data-box click_view_in_ed_now_patients cursor_pointer" data-ward="sdec"
                            data-type="en_ed_now">
                            <h6>In ED Now</h6>
            ...
            <div class="col-xxl-2 col-lg-9 col-md-10 mb-2">
            ...
            <div class="col-xxl-1 col-lg-3 col-md-2 mb-2 sdec_patient_view_offcanvas">
                <div class="sdec-patient-count">
                    ...
                    <div class="count-box">
                        <h6>{{ $success_array['ane_patients_to_sdec'] }}</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-2">
                ...
                <div class="waiting-area">
                    ...
                    <div class="row gx-0 droppable " data-area="0">
                        @foreach ($waiting_area as $patient)
                            <div class="col-xxl-6 col-lg-12 col-md-6 draggable its_a_bed"
                                        ...
                                        <div class="col-12 pe-0 ps-0">
                                            <div class="ward-header-row">
                                                ...
                                                <div class="header-col-2 bed_black_background ">
                                                    <a
                                                        @if (CheckSpecificPermission('camis_boardround_view')) href="{{ route('ward.sdec.boardround', $patient['camis_patient_id']) }}" @else href="#" @endif><img
                                ...
                                <div class="medical-details-card cubical-card patient "
                                    ...
                                    @else
                                        <div class="sortable-placeholder droppable ">
                                            <div class="col-xxl-6 col-lg-12 col-md-6 draggable">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 pe-0 ps-0">
                                                            <div class="ward-header-row">
                                                                ...
                                                                <div class="header-col-2 bed_black_background">
                                                                    <a
                                                                        @if (CheckSpecificPermission('camis_boardround_view')) href="{{ route('ward.sdec.boardround', $patient['camis_patient_id']) }}" @else href="#" @endif>
            ...
            <div class="col-lg-4">
                <div class="planned-area">
                    <div class="bg-area-patient bg-area-green">
                        <h6>Planned Area</h6>
                    </div>
                    <div class="row gx-0 bed_section_type" data-area="2">
                        @foreach ($planned_area as $patient)
                            <div class="col-xxl-6 col-lg-12 col-md-6 ">
                                <div class="medical-details-card cubical-card patient "
                                    data-bed-id="{{ $patient['bed_id'] }}">
                                    <div class="row">
...
<script>
    ...
    function intialLoadCard() {
        ...
        $('.ED-area .droppable').each(function() {
            const $dropArea = $(this);
        ...
        $('.planned-area .droppable').each(function() {
            const $dropArea = $(this);
    ...
    function updateAllPositions() {
        ...
        $.ajax({
            url: '{{ route('update.sdec.position') }}',
            type: 'POST',
            data: {
