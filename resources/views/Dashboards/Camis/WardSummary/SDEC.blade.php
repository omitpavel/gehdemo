...
@push('custom-style')
    ...
    <link rel="stylesheet" href="{{ asset('asset_v2/Template/Css/WardSdec.css') }}" crossorigin="anonymous" />
...
@section('footer')
    ...
    <script>
        ...
        $(document).on("click", ".click_open_movement_history", function(e) {
            ...
            var sau_patient_data = new bootstrap.Offcanvas(document.getElementById('sdec_patient_movement_offcanvas'), {
            ...
            var url = "{{ route('ward.sdec.movement.history') }}";
            if(camis_patient_id != ''){
                ...
                $.ajax({
                    ...
                    error: function(textStatus, errorThrown) {
                        ...
                        CloseOffcanvas('sdec_patient_movement_offcanvas');
