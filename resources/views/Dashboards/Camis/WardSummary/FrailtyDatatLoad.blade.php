<input type="hidden" value="{{ $frailty_ward_id }}" id="ward_id">
<div class="col-lg-12">
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 mb-2">
                <div class="edd-header">
                    <div class="grey-tile-bottom">
                        <div class="edd-data-box click_view_in_ed_now_patients cursor_pointer" data-ward="frailty"
                            data-type="en_ed_now">
                            <h6>In ED Now</h6>
                                        ...
                                        <div class="col-12 pe-0 ps-0">
                                            <div class="ward-header-row">
                                                ...
                                                <div class="header-col-2 bed_black_background ">
                                                    <a
                                                        @if (CheckSpecificPermission('camis_boardround_view')) href="{{ route('ward.frailty.boardround', $patient['camis_patient_id']) }}" @else href="#" @endif><img
            ...
            <div class="col-lg-6">
                <div class="assesment-area">
                    <div class="bg-area-patient">
                        <h6>Frailty Assessment Unit</h6>
                    </div>
                    <div class="row gx-0 bed_section_type" data-area="1">
                        @foreach ($frailty_area as $patient)
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 pe-0 ps-0">
                                                            <div class="ward-header-row">
                                                                ...
                                                                <div class="header-col-2 bed_black_background">
                                                                    <a
                                                                        @if (CheckSpecificPermission('camis_boardround_view')) href="{{ route('ward.frailty.boardround', $patient['camis_patient_id']) }}" @else href="#" @endif>
...
<script>
    ...
    function updateAllPositions() {
        ...
        $.ajax({
            url: '{{ route('update.frailty.position') }}',
            type: 'POST',
            data: {
