...
<div class="assign-task-offcanvas offcanvas offcanvas-end" tabindex="-1" data-bs-backdrop="static" id="camis_patient_ward_summary_boardround_assign_task"
            ...
            <input type="hidden" class='boardround_patient_task_id_update ibox_board_round_patient_task_description_open ui-autocomplete-input' name="boardround_patient_task_id_update" id="boardround_patient_task_id_update" value="" />
             ...
             <div class="mb-2">
                 <div class="row  g-2 mb-2">
                     <div class="col-md-4 ">
                         <button type="button" class="btn btn-primary-grey w-100 ibox_board_round_patient_task_assign_priority_inner">PRIORITY </button>
                     </div>
                     <div class="col-md-4 ">
    ...
    <div class="row ibox_modal_footer_button_class">
        ...
        <div class="row g-2">
            <div class="col-lg-6 col-md-6 col-6">
                <button class="btn btn-primary-grey all_modal_save_button_for_js bottom-save-button camis_patient_ward_summary_boardround_save_task_create_or_update"><img class='loading-save-svg-to-show-on-save'
