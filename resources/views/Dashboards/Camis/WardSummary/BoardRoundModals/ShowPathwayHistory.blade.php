<div class="row gx-2">
    <div class="col-xl-8">
        <div class="card-pathway-history">
            <table class="breachReasonTable responsiveTable table-pathway-history">
                <thead>
    ...
    <div class="col-xl-4">
        <div class="card-pathway-history medfit">
            <div class="p-2">
                <h6 class="mb-0">Med Fit History</h6>
            </div>
            <table class="breachReasonTable responsiveTable table-medfit-history">
                <thead>
                    <tr class="position-relative">
                        <th>Consultant</th>
                        <th>Med Fit</th>
