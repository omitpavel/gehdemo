                                        ...
                                        <div class="col-md-8">
                                            <div class="card-boxes">
                                                @if(isset($success_array['patient_details']['board_round_reason_to_reside']) && isset($success_array['patient_details']['board_round_reason_to_reside']['reason_to_reside_category']['reason_to_reside_text_value_category']))
                                                    ...
                                                    <a class="btn text-center mb-0 ">{{str_replace('.', ',',str_replace('_', ' ', ucwords($success_array['patient_details']['board_round_reason_to_reside']['reason_to_reside_category']['reason_to_reside_text_value_category'])))}}
                                                    </a>
                                                @else
                                                    <a class="btn text-center mb-0 ">No Reason To Reside</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
