...
@section('footer')
    ...
    <script>
        ...
        "{{ route('ward.discharge.lounge.dataload') }}";
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                _token: tok,
                url: '{{ route('ward.discharge.lounge.dataload') }}',
                type: 'GET',
                data: {
                    "_token": tok
                },
        ...
        $(document).on("click", ".click_open_movement_history", function(e) {
            ...
            var sau_patient_data = new bootstrap.Offcanvas(document.getElementById('discharge_lounge_patient_movement_offcanvas'), {
            ...
            var url = "{{ route('ward.discharge.lounge.movement.history') }}";
            if(camis_patient_id != ''){
                ...
                $.ajax({
                    ...
                    error: function(textStatus, errorThrown) {
                        ...
                        CloseOffcanvas('discharge_lounge_patient_movement_offcanvas');
