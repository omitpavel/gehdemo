...
@section('footer')
    ...
    <script>
        ...
        $( document ).ready(function()
        {
            ...
            var ajax_refresh_url = "{{ route('ward.sdec.boardround.data', request()->patient_id) }}";
        ...
        function BoardRoundData(camis_patient_id) {
            ...
            var updated_url = current_url.replace(/sdec-board-round\/\w+/, 'sdec-board-round/' + camis_patient_id);
            ...
            $.ajax({
                url: "{{ route('ward.sdec.boardround.data', request()->patient_id) }}",
                type: 'GET',
                data: {
                    "_token": token,
