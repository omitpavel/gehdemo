...
<div class="sidenav-link">
    <span @if(CheckDashboardPermission('surgical_wards_dashboard_view')) class="{{ Request::routeIs('surgical.ward') ? 'active' : '' }}" @else class="ibox-side-menu-disabled-icon " onclick="CommonLoginModalPopupOpenOnRequest();"  @endif>
        <a @if(CheckDashboardPermission('surgical_wards_dashboard_view')) href="{{ route('surgical.ward') }}" @endif  class="{{ Request::RouteIs('surgical.ward') ? 'active' : '' }}">Surgical Handover
    ...
    <span  @if(CheckDashboardPermission('doctor_at_night_dashboard_view')) class="{{ Request::routeIs('doctor.at.night') ? 'active' : '' }}"  @else class="ibox-side-menu-disabled-icon " onclick="CommonLoginModalPopupOpenOnRequest();"  @endif>
        <a @if(CheckDashboardPermission('doctor_at_night_dashboard_view')) href="{{ route('doctor.at.night') }}"  @endif  class="{{ Request::RouteIs('doctor.at.night') ? 'active' : '' }}">Doctor At Night
            <svg width="14.132" height="15.528" viewBox="0 0 14.132 15.528">
                <g id="Group_2333" data-name="Group 2333" transform="translate(14.132) rotate(90)" opacity="0.29">
                    <path id="Path_19238" data-name="Path 19238"
                        d="M7.674,0h.178a1.218,1.218,0,0,1,.865.358L15.17,6.811a1.22,1.22,0,0,1-1.724,1.727L7.765,2.854,2.08,8.538A1.22,1.22,0,0,1,.356,6.811L6.81.358A1.228,1.228,0,0,1,7.674,0Z"
    ...
    <span @if(CheckDashboardPermission('stranded_dashboard'))  class="{{ Request::routeIs('site.stranded_patients') ? 'active' : '' }}" @else class="ibox-side-menu-disabled-icon " onclick="CommonLoginModalPopupOpenOnRequest();"  @endif>
        <a @if(CheckDashboardPermission('stranded_dashboard'))  href="{{ route('site.stranded_patients') }}" @endif  class="{{ Request::RouteIs('site.stranded_patients') ? 'active' : '' }}">Standard Patient
            <svg width="14.132" height="15.528" viewBox="0 0 14.132 15.528">
                <g id="Group_2333" data-name="Group 2333" transform="translate(14.132) rotate(90)" opacity="0.29">
                    <path id="Path_19238" data-name="Path 19238"
                        d="M7.674,0h.178a1.218,1.218,0,0,1,.865.358L15.17,6.811a1.22,1.22,0,0,1-1.724,1.727L7.765,2.854,2.08,8.538A1.22,1.22,0,0,1,.356,6.811L6.81.358A1.228,1.228,0,0,1,7.674,0Z"
