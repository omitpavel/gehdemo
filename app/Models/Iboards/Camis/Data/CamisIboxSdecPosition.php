...
class CamisIboxSdecPosition extends Model
{
    protected $guarded      = [];
    protected $connection   = 'mysql_camis_data';
    protected $table        = 'ibox_patient_sdec_postion';
    ...
    public function SdecPosition()
    {
        return $this->hasOne(BedDetails::class, 'id', 'sdec_bed_id');
    }
