...
class CamisAeToSDECWaiting extends Model
{
    protected $guarded      = [];
    protected $connection   = 'mysql_camis_data';
    protected $table        = 'v_ae_to_sdec_patient_waiting_list';
    ...
    {
        return RetriveSpecificConstantSettingValues("mysql_camis_data", "ibox_constant_database_names") . ".v_ae_to_sdec_patient_waiting_list";
    }
