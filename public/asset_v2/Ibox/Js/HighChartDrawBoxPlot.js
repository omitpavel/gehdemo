...
var box_plot_var_plot_options = { boxplot: { fillColor: '#000000', lineWidth: 1, medianColor: '#000000', medianWidth: 2, stemColor: '#000000', stemWidth: 1, whiskerColor: '#000000', whiskerWidth: 2 } };
    ...
    Highcharts.chart(chart_id, {
     boost: {
         ...
         series: [{
              ...
              showInLegend: false,
              name: '',
              data: [[minimum_val, lower_quartile_val, midian_val, upper_quartile_val, maximum_val]],
              fillColor: 'red',
              tooltip: {
                   headerFormat: '',
