...
if (document.querySelector("#breach-weekly-chart1")) {
    var chart = new ApexCharts(document.querySelector("#breach-weekly-chart1"), options);
    chart.render();
}

// Breach weekly Dashboard chart-1
...
if (document.querySelector("#breach-weekly-chart2")) {
    var chart = new ApexCharts(document.querySelector("#breach-weekly-chart2"), options);
    chart.render();
}
...
if (document.querySelector("#breach-weekly-chart3")) {
    var chart = new ApexCharts(document.querySelector("#breach-weekly-chart3"), options);
    chart.render();
}
...
if (document.querySelector("#overview-boxplot-ae")) {
    var chart = new ApexCharts(document.querySelector("#overview-boxplot-ae"), options);
    chart.render();
}
...
// Overview Dashboard Column Todays  chart
...
if (document.querySelector("#overview-today-chart")) {
    var chart = new ApexCharts(document.querySelector("#overview-today-chart"), options);
    chart.render();
}



// Referral Dashboard Boxplot  chart

var options = {
    series: [{
        data: [{
                x: '',
                y: [1000, 2000, 3900, 5550, 6000]
            },
...
if (document.querySelector("#referral-boxplot-chart")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-chart"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 2
...
if (document.querySelector("#referral-boxplot-2")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-2"), options);
    chart.render();
}
// Referral Dashboard Boxplot  chart- 3
...
if (document.querySelector("#referral-boxplot-3")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-3"), options);
    chart.render();
}
// Referral Dashboard Boxplot  chart- 4
...
if (document.querySelector("#referral-boxplot-4")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-4"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 5
...
if (document.querySelector("#referral-boxplot-5")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-5"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 6
...
if (document.querySelector("#referral-boxplot-6")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-6"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 7
...
if (document.querySelector("#referral-boxplot-7")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-7"), options);
    chart.render();
}
// Referral Dashboard Boxplot  chart- 8
...
if (document.querySelector("#referral-boxplot-8")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-8"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 9
...
if (document.querySelector("#referral-boxplot-9")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-9"), options);
    chart.render();
}

// Referral Dashboard Boxplot  chart- 10
...
if (document.querySelector("#referral-boxplot-10")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-10"), options);
    chart.render();
}
// Referral Dashboard Boxplot  chart- 11
...
if (document.querySelector("#referral-boxplot-11")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-11"), options);
    chart.render();
}
// Referral Dashboard Boxplot  chart- 12
...
if (document.querySelector("#referral-boxplot-12")) {
    var chart = new ApexCharts(document.querySelector("#referral-boxplot-12"), options);
    chart.render();
}
 //  Deteriorating Patient Response Time Combo chart
...
if (document.querySelector("#response-time-chart")) {
    var chart = new ApexCharts(document.querySelector("#response-time-chart"), options);
    chart.render();
}

// Deteriorating Patient Line  chart
...
if (document.querySelector("#response-line-chart")) {
    var chart = new ApexCharts(document.querySelector("#response-line-chart"), options);
    chart.render();
}

// Deteriorating Patient Task response chart


var options = {
    series: [{
        data: [04, 06, 04, 10, 08, 30, 20,04, 06, 04, 10, 08, 30, 20],
    ...
    colors: ['#EE3B3B','#FF944D', '#BAD350', '#7BDCA6', '#01C5BB', '#5FA1A1', '#42C0FB', '#42647F','#8470FF','#990099','#C24444','#D4318C','#E31230'],
    dataLabels: {
        enabled: false
    },
    ...
    xaxis: {
        categories: ['Escalation Status', 'Code Red / SBAR Documentedin Notes', 'TEP in Place', 'DNACPR Status Documented', 'Capacity Assessment (MCA)  Confirmed/Completed', 'Sepsis Assessment', 'AKI Assessment', 'Capillary Blood Glucose', 'Review Diabetic Status', 'Working Diagnosis Update on ibox', 'Medical Plan Documented and Shared latest Nursing Team', 'Review Latest Investigations', 'Task List/ Case Reviewed',
...
if (document.querySelector("#task-response-chart")) {
    var chart = new ApexCharts(document.querySelector("#task-response-chart"), options);
    chart.render();
}
        ...
        var options = {
          series: [{
          name: 'Function',
          data: [44, 55, 41,67, 22, 43, 67, 22, 43,70]
        }, {
          name: 'Physiology',
          data: [20, 8, 13, 27,13, 23, 20, 8, 13, 27]
        }, {
          name: 'Recovery',
          data: [11, 17, 15,20, 8, 13, 27, 15, 21, 14]
        }, {
          name: 'Teatment',
          data: [21, 7, 25, 13, 22, 8,20, 8, 13, 27]
        }],
            chart: {
                      toolbar: {
            show: false,
    ...
    fontFamily: 'Poppins, sans-serif',
          ...
          zoom: {
            enabled: true
               ...
               colors: ['#ABABAB', '#007680', '#00C2D3','#ABC3DB'],
        ...
        xaxis: {
          type: 'datetime',
          categories: ['19 Jun 2023', '17 Jun 2023', '15 Jun 2023', '13 Jun 2023',
            '12 Jun 2023', '10 Jun 2023','08 Jun 2023','06 Jun 2023','04 Jun 2023','02 Jun 2023'
          ],
        },
               legend: {
            show:false,
  ...
  if (document.querySelector("#reason-reside-chart")) {
    var chart = new ApexCharts(document.querySelector("#reason-reside-chart"), options);
    chart.render();
  }
  ...
  if (document.querySelector("#reason-ward-chart")) {
    var chart = new ApexCharts(document.querySelector("#reason-ward-chart"), options);
    chart.render();
  }
    ...
    fontFamily: 'Poppins, sans-serif',
        ...
        stroke: {
          curve: 'straight'
                     ...
                     colors: ['#FB0044', '#00A42C', '#DE6000','#017DC7'],
    ...
    if (document.querySelector("#reason-line-chart")) {
    var chart = new ApexCharts(document.querySelector("#reason-line-chart"), options);
    chart.render();
  }
    ...
    if (document.querySelector("#reason-line-chart2")) {
    var chart = new ApexCharts(document.querySelector("#reason-line-chart2"), options);
    chart.render();
  }
...
if (document.querySelector("#gehBreachChart1")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachChart1"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachChart2")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachChart2"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachChart3")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachChart3"), options);
    chart.render();
}

// Breach Dashboard chart-4
...
if (document.querySelector("#breach-chart4")) {
    var chart = new ApexCharts(document.querySelector("#breach-chart4"), options);
    chart.render();
}

// Breach Dashboard chart-5
...
if (document.querySelector("#breach-chart5")) {
    var chart = new ApexCharts(document.querySelector("#breach-chart5"), options);
    chart.render();
}

// Breach Dashboard chart-6
...
if (document.querySelector("#breach-chart6")) {
    var chart = new ApexCharts(document.querySelector("#breach-chart6"), options);
    chart.render();
}

// Breach Dashboard chart-7
...
if (document.querySelector("#breach-chart7")) {
    var chart = new ApexCharts(document.querySelector("#breach-chart7"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachWeeklyChart1")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart1"), options);
    chart.render();
}


// Breach Weekly Dashboard chart-2
...
if (document.querySelector("#gehBreachWeeklyChart2")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart2"), options);
    chart.render();
}

// Breach Weekly Dashboard chart-3
...
if (document.querySelector("#gehBreachWeeklyChart3")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart3"), options);
    chart.render();
}

// Breach Weekly Dashboard chart-4
...
if (document.querySelector("#gehBreachWeeklyChart4")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart4"), options);
    chart.render();
}

// Breach Weekly Dashboard chart-5
...
if (document.querySelector("#gehBreachWeeklyChart5")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart5"), options);
    chart.render();
}

// Breach Weekly Dashboard chart-6
...
if (document.querySelector("#gehBreachWeeklyChart6")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart6"), options);
    chart.render();
}

// Breach Weekly Dashboard chart-7
...
if (document.querySelector("#gehBreachWeeklyChart7")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachWeeklyChart7"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachMonthlyChart1")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart1"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachMonthlyChart2")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart2"), options);
    chart.render();
}
...
if (document.querySelector("#gehBreachMonthlyChart3")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart3"), options);
    chart.render();
}

// Breach Monthly Dashboard chart-4
...
if (document.querySelector("#gehBreachMonthlyChart4")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart4"), options);
    chart.render();
}

// Breach Monthly Dashboard chart-5
...
if (document.querySelector("#gehBreachMonthlyChart5")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart5"), options);
    chart.render();
}

// Breach Monthly Dashboard chart-6
...
if (document.querySelector("#gehBreachMonthlyChart6")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart6"), options);
    chart.render();
}

// Breach Monthly Dashboard chart-7
...
if (document.querySelector("#gehBreachMonthlyChart7")) {
    var chart = new ApexCharts(document.querySelector("#gehBreachMonthlyChart7"), options);
    chart.render();
}