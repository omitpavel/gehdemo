    ...
    (r.prototype.init = function () {
                        ...
                        (this.init.addIdsAndClasses = function (e) {
                            e._timelineComponents(n),
                                1 == n.eventsContentList.length
                                    ? (n.eventsContentList.first().attr("id", "first"), n.timelineEvents.first().addClass("first"))
                                    : (n.eventsContentList.addClass(e.settings.animation_baseClass).first().attr("id", "first").end().last().attr("id", "last"), n.timelineEvents.first().addClass("first").end().last().addClass("last"));
                        }),
        ...
        (r.prototype._create = function () {
            ...
            1 == this.settings.useNavBtns || 1 == this.settings.useScrollBtns
                ? (r.append('<div class="timeline-navigation" id="leftNav"></div>').append(t).append('<div class="timeline-navigation" id="rightNav"></div>'),
                  0 == this.settings.useNavBtns && 1 == this.settings.useScrollBtns
                      ? r.find("#leftNav").append(i).end().find("#rightNav").append(a)
                      : 1 == this.settings.useNavBtns && 0 == this.settings.useScrollBtns
                      ? r.find("#leftNav").append(n).end().find("#rightNav").append(s)
                      : 1 == this.settings.useNavBtns && 1 == this.settings.useScrollBtns && r.find("#leftNav").append(i).append(n).end().find("#rightNav").append(s).append(a))
                : (r.append(t), r.find(".events-wrapper").css("min-width", "100%")),
                1 == this.settings.autoplay && r.append('<div class="timeline-navigation" id="pausePlay"></div>').find("#pausePlay").append(l),
                    ...
                    if (-1 == jQuery.inArray(l, C))
                        if (r) {
                            ...
                            void 0 !== N
                                ...
                                : f
                                ? "append" == s
                                    ? m.append(v + T + g(T) + "<br>" + y(W) + "</a>")
                                    : "after" == s
                                    ? _.after(v + T + g(T) + "<br>" + y(W) + "</a>")
                                    : _.before(v + T + g(T) + "<br>" + y(W) + "</a>")
                                : u
                                ? "append" == s
                                ...
                                : c && ("append" == s ? m.append(v + O + "</a>") : "after" == s ? _.after(v + O + "</a>") : _.before(v + O + "</a>"));
                        } else if (o) {
                            var x = l,
                                N = t._timelineData(i, "customDisplay");
                            void 0 !== N
                                ? "append" == s
                                    ...
                                    ? _.after(v + N + "</a>")
                                    : _.before(v + N + "</a>")
                                : (d || h) && ("append" == s ? m.append(v + x + "</a>") : "after" == s ? _.after(v + x + "</a>") : _.before(v + x + "</a>"));
                        } else {
                            var w = l,
                                D = w.split("/"),
                                T = D[0].replace(/^0+/, ""),
        ...
        (r.prototype._timelineComponents = function (e) {
            (e.eventsContent = this.$element.children(".events-content")),
                ...
                (e.timelineNavigation = e.timelineWrapper.siblings(".timeline-navigation"));
        }),
        (r.prototype._setup = function (i, s, a) {
            ...
            if (
                ...
                this.$element
                    .on("click." + this._name, ".timeline-navigation .inactive", function (e) {
                    ...
                    .on(
                        ...
                        e.proxy(function () {
                            ...
                            this._timelineComponents(s),
                                ...
                                t.is(".next") && this._showNewContent(s, a, "next"),
                                t.is(".prev") && this._showNewContent(s, a, "prev"),
                                t.is(".scroll-right") && this._updateSlide(s, a, "right"),
                                t.is(".scroll-left") && this._updateSlide(s, a, "left");
                        }, this)
                    )
                    .on(
                        "click." + this._name,
                ...
                if (
                    (s.eventsContent.prepend('<div class="progressBarWrapper"><div class="progressBar"></div></div>'),
                    (this._setup.autoplay = function (t) {
                        ...
                        function d() {
                            if (((i = t.$element.data("plugin_" + t._name).autoplay.isPaused), this._timelineComponents(s), !1 === i && this._elementInViewport(this.element))) {
                                var e = this._checkMQ();
                                (a += "tinyMobile" == e || "mobile" == e ? 3 / o : 1 / o),
                                    this.$element.find(".progressBar").css({ width: a + "%" }),
                                    (l = s.eventsWrapper.find(".selected").index()),
                                    a >= 100 &&
                                        (("normal" == this.settings.dateOrder && l == this._setup.autoplay.countEvents()) || ("reverse" == this.settings.dateOrder && 1 == l)
                                            ? (this._showNewContent(s, r, "start"), (l = s.eventsWrapper.find(".selected").index()))
                                            : "normal" == this.settings.dateOrder
                                            ? this._showNewContent(s, r, "next")
                                            : "reverse" == this.settings.dateOrder && this._showNewContent(s, r, "prev"));
                            }
                        }
                        (t.$element.data("plugin_" + t._name).autoplay = { isPaused: !1, mouseEvent: !1 }),
                            ...
                            (t._setup.autoplay.changeButtons = function (e) {
                                ...
                                "click" == e.type && 1 == i
                                    ? (a.addClass("clicked"), (this.$element.data("plugin_" + this._name).autoplay.mouseEvent = "click"), a.html(l), this._setup.autoplay.pause(), console.log("Autoplay is " + s + "."))
                                    : "click" != e.type ||
                                      i ||
                                      (a.removeClass("clicked"), (this.$element.data("plugin_" + this._name).autoplay.mouseEvent = !1), a.html(n), this._setup.autoplay.resume(), console.log("Autoplay is " + s + "."));
                                "mouseenter" != e.type || a.hasClass("clicked")
                                    ? "mouseleave" != e.type ||
                                      a.hasClass("clicked") ||
                                      ((this.$element.data("plugin_" + this._name).autoplay.mouseEvent = !1), a.html(n), this._setup.autoplay.resume(), console.log("Autoplay is " + s + "."))
                                    : ((this.$element.data("plugin_" + this._name).autoplay.mouseEvent = "hover"), a.html(l), this._setup.autoplay.pause(), console.log("Autoplay is " + s + "."));
                            }),
                    ...
                    this.$element
                        .on("click." + this._name, ".timeline-navigation .pause", [!0, h, "paused"], e.proxy(this._setup.autoplay.changeButtons, this))
                        .on("click." + this._name, ".timeline-navigation .play", [!1, h, "playing"], e.proxy(this._setup.autoplay.changeButtons, this)),
                    1 == this.settings.autoplayPause_onHover)
                ) {
                    var f = this._checkMQ();
                    ("smallTablet" != f && "tablet" != f && "desktop" != f) ||
                        this.$element
                            .on("mouseenter." + this._name, ".events-content", [!1, h, "paused"], e.proxy(this._setup.autoplay.changeButtons, this))
                            .on("mouseleave." + this._name, ".events-content", [!1, h, "playing"], e.proxy(this._setup.autoplay.changeButtons, this));
                }
            }
            ...
            if (u.length > 0) {
                u.on("click." + this._name, function (t) {
                    ...
                    s ? o.goTo(r, o) : o.goTo(r, { smoothScroll: !0, speed: scrollSpeed, offset: scrollOffset, easing: scrollEasing }, o);
                });
            }
            if (1 == this.settings.useScrollWheel) {
                var c = "/asset_v2/Generic/timeline/js/jquery.mousewheel.min.js";
            ...
            if (1 == this.settings.useTouchSwipe) {
                c = "/asset_v2/Generic/timeline/js/jquery.touchSwipe.min.js";
                (this._setup.swipe = function (e, t) {
                    ...
                    s.timelineWrapper.addClass("touch-enabled").parent().siblings(".events-content").addClass("touch-enabled");
            }
            if (1 == this.settings.useKeyboardKeys) {
                this._setup.keyboardKeys = function (e) {
                    this._timelineComponents(s),
                        (a = this._setTimelineWidth(s)),
                        "37" == e.which && this._elementInViewport(this.element) ? this._showNewContent(s, a, "prev") : "39" == e.which && this._elementInViewport(this.element) && this._showNewContent(s, a, "next");
                };
                p = this.$element.attr("id");
        ...
        (r.prototype.refresh = function () {
            ...
            this._timelineComponents(e),
                e.eventsContent.find("#first").removeAttr("id").end().find("#last").removeAttr("id").end(),
                e.eventsWrapper.find(".first").removeClass("first").end().find(".last").removeClass("last").end(),
                this.init.addIdsAndClasses(this),
                this._setDatePosition(e),
                (timelineTotalWidth = this._setTimelineWidth(e)),
                this._updateFilling(e.eventsWrapper.find("a.selected"), e.fillingLine, timelineTotalWidth),
                1 == this.settings.autoplay && this._setup.autoplay.refresh(this),
        ...
        (r.prototype.destroy = function () {
            ...
            1 == e(".horizontal-timeline .timeline").length && (e(".goto-horizontal-timeline").off("." + this._name), e("body").removeData("plugin_" + this._name + "_loadedFile")),
                i
                    .removeClass("loaded")
                    .off("." + this._name, "**")
                    .find(".timeline")
        ...
        (r.prototype.addEvent = function (t, i, n) {
            ...
            o.push(a),
                ...
                this.refresh(),
                this.$element.trigger({ type: "eventAdded." + this._name, newEventDate: a, newEventContent: t });
        }),
        (r.prototype.removeEvent = function (t) {
            ...
            i.timelineEvents.length > 1
                ? (s.is(".selected")
                      ? (a.removeClass(".selected"), s.next().length ? ((n = s.next().addClass("selected")), a.next().addClass("selected")) : ((n = s.prev().addClass("selected")), a.prev().addClass("selected")))
                  ...
                  r > -1 && l.splice(r, 1),
                  this.refresh(),
                  this.$element.trigger({ type: "eventRemoved." + this._name, removedDate: t, removedContent: a[0].outerHTML }))
        ...
        (r.prototype.goTo = function (t, { smoothScroll: i = !1, speed: n = 500, offset: s = 0, easing: a = "linear" } = {}, l) {
            var r = {};
            ...
            e("body").trigger({ type: "goToTimeline." + this._name, goToDate: t, timelineSelector: l.$element });
            ...
            1 == i
                ? e("html, body")
                      .stop()
                      .animate({ scrollTop: l.$element.offset().top - s }, n, a, function () {
                          f(l);
                      })
                : f(l);
        }),
            ...
            if (s.length > 0 || ("reverse" == this.settings.dateOrder && "start" == i)) {
                ...
                "start" == i
                    ? "normal" == this.settings.dateOrder
                        ...
                        : "reverse" == this.settings.dateOrder && (a = e.eventsWrapper.find(".last"))
                    : "next" == i
                    ? (a = l.next("a"))
                    : "prev" == i && (a = l.prev("a")),
        ...
        (r.prototype._setDatePosition = function (e) {
            ...
            var a = this._checkMQ();
            for ((1 != this.settings.minimalFirstDateInterval && "tinyMobile" != a && "mobile" != a) || (e.timelineEvents.first().css({ left: "0px", "padding-left": "10px" }), (s = 1)), i = s; i < e.timelineEvents.length; i++)
        ...
        (r.prototype._updateVisibleContent = function (t, i) {
            ...
            newContent.addClass(l),
                ...
                this.$element.trigger({ type: "eventChanged." + this._name, currentEventDate: a });
        }),
        ...
        (r.prototype._getTranslateValue = function (e) {
            ...
            if ((n = i.getPropertyValue("-webkit-transform") || i.getPropertyValue("-moz-transform") || i.getPropertyValue("-ms-transform") || i.getPropertyValue("-o-transform") || i.getPropertyValue("transform")).indexOf("(") >= 0)
                var n,
                    s = (n = (n = (n = n.split("(")[1]).split(")")[0]).split(","))[4];
            else s = 0;
            return Number(s);
        }),
        (r.prototype._setTransformValue = function (e, t, i) {
            e.css({ "-webkit-transform": t + "(" + i + ")", "-moz-transform": t + "(" + i + ")", "-ms-transform": t + "(" + i + ")", "-o-transform": t + "(" + i + ")", transform: t + "(" + i + ")" });
        }),
        ...
        (r.prototype._setDateIntervals = function (e) {
            ...
            "tinyMobile" == t || "mobile" == t
                ...
                : "desktop" == t && (dateIntervals = this.settings.desktopDateIntervals);
        ...
        (r.prototype._buttonStates = function (e, t, i) {
            ...
            Number(e.timelineWrapper.css("width").replace("px", "")) == e.eventsWrapper.width() && (a.addClass("inactive"), l.addClass("inactive")),
                1 == e.eventsContentList.length
                    ? (s.addClass("inactive"), n.addClass("inactive"))
                    : (r.is(".selected") ? s.addClass("inactive") : s.removeClass("inactive"), o.is(".selected") ? n.addClass("inactive") : n.removeClass("inactive")),
        ...
        (r.prototype._addFile = function (t, i, n) {
            if (1 == this.settings.addRequiredFile) {
                ...
                l ? (s = e('script[src*="' + o + '"]')) : r && (s = e('link[href*="' + o + '"]')),
                    null == a && (a = new Array()),
                    -1 != a.indexOf(t) || s.length
                        ? s.length && -1 == a.indexOf(t)
                            ? (l &&
                                  (console.groupCollapsed(o + " on " + this.$element.attr("id") + " timeline"),
                              ...
                              a.push(t))
                            : l && (console.groupCollapsed(o + " on " + this.$element.attr("id") + " timeline"), console.log("The plugin has already been loaded, no need to load it again."), "function" == typeof n && n(this))
                        : (l
                              ? (console.groupCollapsed(o + " on " + this.$element.attr("id") + " timeline"),
                              ...
                              : r &&
                                ...
                                console.log("The plugin isn't loaded."),
                                e("<link>").attr({ href: t, rel: "stylesheet", type: "text/css" }).insertAfter(e("head").find("link").last()),
                                console.log("It was loaded dynamically.")),
                          a.push(t)),
        ...
        (e.fn[a] = function (i) {
            ...
            return i === s || "object" == typeof i
                ? this.each(function () {
                      e.data(this, "plugin_" + a) || e.data(this, "plugin_" + a, { originalEventsContent: e(this).find(".events-content").clone()[0], windowWidth: o, existingDates: d, Timeline: new r(this, i) });
                  })
